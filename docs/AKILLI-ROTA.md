# Eskişehir Keşif Asistanı — demo v4

8 Eylül 2026. Katalog sürümü: `2026-09-08.3`.
...
2. **Sert filtreler:** Seçili ilçeler gerçek bir kısıttır: yalnız bu ilçelerden ziyaret seçilir ve her seçili ilçe tam planda temsil edilmelidir. Frigya seçimi en az bir gerçek Frigya durağı gerektirir. Uyumsuz ulaşım veya yetersiz süre, merkez rotasına sessiz dönüş yapmaz. Ziyaret dışı / çıkarılmış duraklar, bilinen kapalı gün, bilet, az yürüyüş ve iç mekân tercihleri. Bisiklet, yürüyüş ve toplu ulaşımda ilçe keşfi seçilince her alternatif için yerel bir başlangıç değerlendirilir. Sabit başlangıç seçimi korunur ve sessizce merkeze çevrilmez. İlçeye erişim programdan ayrı gösterilir; kırsal toplu ulaşım seçiminin yerel bölümü yürüyüştür.
...
4. **Ulaşım zamanı:** Kısa bağlantıda yürüyüş; bisiklette kentte 14, kırsalda 11 km/sa, kent içi araçta 25 km/sa, kırsal otomobilde 55 km/sa ve motosiklette 50 km/sa gibi model hızları. Toplu ulaşımda bekleme, araçta park, uzun sürüşte dinlenme süreleri eklenir. Motosiklet için hız yarışı teşvik edilmez; karayolu erişimi kullanılır.
...
- `startMode=district`: Bisiklet, yürüyüş ve toplu ulaşımda varsayılan keşif biçimi. Her yerel başlangıç için bağımsız gün planlanır. Her `DayPlan.origin` gerçek başlangıcı taşır; alternatifler ve çok günlük programlar bu değerleri korur. Otomobil ve motosiklet kendi sabit başlangıcıyla hesaplanmaya devam eder.
...
- Toplu ulaşımda kent içi süre modeli sürer; kırsal başlangıç çevresindeki bağlantılar gerçekçi yürüyüş süresiyle hesaplanır, haritada da yürüyüş olarak açılır. İlçeler arasında doğrulanmamış otobüs seferi planlanmaz.
