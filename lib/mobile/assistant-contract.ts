...
export const preferenceSchema=z.object({
  days:z.number().int().min(1).max(4), start:z.number().int().min(360).max(1080),end:z.number().int().min(420).max(1140),
